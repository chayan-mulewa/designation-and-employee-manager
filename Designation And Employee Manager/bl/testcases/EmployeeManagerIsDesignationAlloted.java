...
import java.math.*;
import java.text.*;
class EmployeeManagerIsDesignationAlloted
{
    public static void main(String gg[]) 
    {
        ...
        try
        {
            ...
            boolean isDesignationAlloted=employeeManager.isDesignationAlloted(designationCode);
            System.out.println("");
            System.out.println("**************************************************");
            System.out.println("");
            System.out.println(isDesignationAlloted);
            System.out.println("");
            System.out.println("**************************************************");
